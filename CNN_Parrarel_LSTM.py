...
def create_parallel_cnn_lstm_model(l2_rate=0.00001):
    # Input layer
...
root = 'data/Test/Test_CNN_Parrarel_LSTM/'
model_file = 'data/Test/Test_CNN_Parrarel_LSTM/temperature_prediction_model.hdf5'
...
if train:
    ...
    for i in range(4):
        ...
        model = create_parallel_cnn_lstm_model()
        custom_optimizer = Adam(learning_rate=learning_rate)
