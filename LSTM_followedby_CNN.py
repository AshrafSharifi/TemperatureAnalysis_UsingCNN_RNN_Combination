...
from tensorflow.keras.layers import Input, Conv1D, ReLU, BatchNormalization, Bidirectional, LSTM, Dropout, Dense, Reshape
...
def create_lstm_cnn_model(dropout_rate=0.2, l2_rate=0.00001):
    # Input layer
    ...
    reshape = Reshape((timesteps, 128))(dropout3)
    ...
    conv3 = Conv1D(filters=10, kernel_size=3, strides=1, padding='same')(relu1)
    relu3 = ReLU()(conv3)
    
    # Flatten the output
    flatten = Reshape((timesteps * 10,))(relu3)
...
root = 'data/Test/Test_LSTM_FollowedBy_CNN/'
model_file = 'data/Test/Test_LSTM_FollowedBy_CNN/temperature_prediction_model.hdf5'
